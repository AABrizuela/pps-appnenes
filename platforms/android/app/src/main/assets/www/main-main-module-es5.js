  ...
  function srcAppMainMainPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MainPage = /*#__PURE__*/function () {
      ...
      _createClass(MainPage, [{
        ...
        key: "seleccionarEspaniol",
        value: function seleccionarEspaniol() {
          this.idiomaSeleccionado = "espaniol";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-uno").fadeIn();
        }
      }, {
        key: "seleccionarPortugues",
        value: function seleccionarPortugues() {
          this.idiomaSeleccionado = "portugues";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-uno").fadeIn();
        }
      }, {
        key: "seleccionarIngles",
        value: function seleccionarIngles() {
          this.idiomaSeleccionado = "ingles";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-uno").fadeIn();
        }
      }, {
        key: "seleccionarNumeros",
        value: function seleccionarNumeros() {
          this.categoriaSeleccionada = "numeros";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-dos").fadeIn();
        }
      }, {
        key: "seleccionarAnimales",
        value: function seleccionarAnimales() {
          this.categoriaSeleccionada = "animales";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-dos").fadeIn();
        }
      }, {
        key: "seleccionarColores",
        value: function seleccionarColores() {
          this.categoriaSeleccionada = "colores";
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-dos").fadeIn();
        }
      }, {
        key: "siguienteUno",
        value: function siguienteUno() {
          ...
          setTimeout(function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_3__(".regresar-uno").fadeIn(); //$(".siguiente-dos").fadeIn();  
          }, 500);
        }
      }, {
        key: "removerClases",
        value: function removerClases() {
        ...
        value: function siguienteDos() {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_3__(".cambiar-categoria").fadeIn(); //alert(this.idiomaSeleccionado + "\n" + this.categoriaSeleccionada);
          ...
          setTimeout(function () {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_3__(".regresar-dos").fadeIn(); //$(".siguiente-dos").fadeIn();  
          }, 500);
        }
      }, {
        key: "regresarUno",
        value: function regresarUno() {
          jquery__WEBPACK_IMPORTED_MODULE_3__(".container-categorias").fadeOut();
          jquery__WEBPACK_IMPORTED_MODULE_3__(".regresar-uno").fadeOut();
          jquery__WEBPACK_IMPORTED_MODULE_3__(".siguiente-dos").fadeOut();
          setTimeout(function () {
            jquery__WEBPACK_IMPORTED_MODULE_3__(".container-idiomas").fadeIn(); //$(".siguiente-uno").fadeIn();
        ...
        key: "reproducirAudio",
        value: function reproducirAudio(ruta) {
          var _this = this;

          var audio = new Audio("../../assets/audio/" + this.idiomaSeleccionado + "/" + this.categoriaSeleccionada + "/" + ruta + ".mp3");
          audio.play();
          this.reproducir = true;
          setTimeout(function () {
            _this.reproducir = false;
          }, 2000);
        }
      }, {
        key: "dropear",
        value: function dropear(value) {
          jquery__WEBPACK_IMPORTED_MODULE_3__("#".concat(value)).toggleClass('active');
        }
      }, {
        key: "selectNumeros",
        value: function selectNumeros() {
          this.categoriaSeleccionada = "numeros";
          this.removerClases();
          jquery__WEBPACK_IMPORTED_MODULE_3__(".btnUno").addClass("unoNum");
          jquery__WEBPACK_IMPORTED_MODULE_3__(".btnDos").addClass("dosNum");
        ...
        key: "selectEspaniol",
        value: function selectEspaniol() {
          this.idiomaSeleccionado = "espaniol";
        }
      }, {
        key: "selectPortugues",
        value: function selectPortugues() {
          this.idiomaSeleccionado = "portugues";
        }
      }, {
        key: "selectIngles",
        value: function selectIngles() {
          this.idiomaSeleccionado = "ingles";
        }
      }]);
